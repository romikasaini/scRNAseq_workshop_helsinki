...
#Change your working directory under Session > Set Working Directory > Choose Directory.
...
Next step is to perform principal component analysis on the scaled data using the 2000 variable features as input. I frequired a different subset can be used by using the 'features' argument.
...
##install.packages("/Users/kumariro/Downloads/bmcite.SeuratData_0.3.0.tar.gz", repos = NULL, type = "source")
library(bmcite.SeuratData)
